...
def main_yfinance(name,state_time,period):
    ...
    percent_arr = pr_percentage(state_time,df_with_EMA_main)
    classes_statues = class_est(percent_arr)
...
def pr_percentage(state_time,df_with_EMA):
    ...
    return percent_arr # main alanda bu değer bir değişkene atanacak
