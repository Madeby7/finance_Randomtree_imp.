...
name = "ODAS.IS"
state_time = 300 #int(input("Please enter the state time:: "))
period_ema = 200 #int(input("Please enter the EMA period value:: "))
# -> sadece fonskyonları kullanacağım için şimdilik  kapatıyorum.
...
def main_yfinance(name,state_time,period):
    ...
    new_item = properties(SMI,name,ask,percent_ask,state_time,percent_arr,classes_statues) # -> en sondaki fonksiyondur.
    return new_item
...
#     tr_arr.append(main_yfinance(stock,state_time,period_ema))
